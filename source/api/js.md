---
title: Doric JavaScript API
---

This page summarizes the JavaScript API surface exported by `doric`. For full signatures, check `doric-js/index.d.ts` generated from the framework source.
